...
use crate::concurrent::executors::thread_pool::Result;
...
impl Default for SharedQueueThreadPool {
    fn default() -> Self {
        SharedQueueThreadPool::new(thread::available_parallelism().unwrap().get()).unwrap()
    }
}
